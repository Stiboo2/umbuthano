...
const validateInganga = (cin, cout, next) => {
...
app.get('/inyanga/new', catchAsync (async (cin, cout) => {
    cout.render('inyanga/new');
}));

app.post('/inyanga',  validateInganga, catchAsync(async (cin, cout, next) => {
...
app.put('/inyanga/:id', validateInganga, catchAsync (async (cin, cout) => {
    const {id} = cin.params;
